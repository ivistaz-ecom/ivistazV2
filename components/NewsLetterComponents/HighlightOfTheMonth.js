...
const HighlightOfTheMonth = () => {
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      <div className="relative z-10 lg:max-w-4xl mx-auto text-center px-4">
        {/* Laptop Image */}
        ...
        <div className="flex flex-col items-center justify-center lg:w-[75%] container mx-auto">
          <p className="text-white/90 mt-6 text-sm md:text-lg leading-relaxed font-monument-light py-5">
          ...
          <p className="text-white/90 mt-4 text-sm md:text-lg leading-relaxed pb-10">
