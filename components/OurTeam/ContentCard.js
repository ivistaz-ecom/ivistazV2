  ...
  return (
    <>
      <div className="lg:px-0 px-4">
        <div className="uppercase text-2xl lg:text-[70px] text-[#ff0000]">
          <h2 className="font-monument-bold">Team Experience</h2>
          <h2 className="font-monument-bold lg:-mt-3">& Expertise</h2>
        </div>
