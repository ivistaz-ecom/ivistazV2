...
const TwoWays = () => {
  return (
    <div className="lg:relative w-full bg-black">
      {/* Background Video */}
      <video
        width="100%"
        height="auto"
      ...
      >
        <source src="/generation-for-tech/two-ways-video.webm" type="video/mp4" />
      ...
      <div className="lg:absolute -bottom-20 px-5 left-0 w-full flex flex-col md:flex-row z-10 ">
        ...
        <div className="w-full md:w-1/2">
          <div className="bg-gradient-to-r from-[#322596] to-[#8C1FBC] text-white px-8 md:px-10 py-5">
          ...
          <div className="bg-white p-8 md:p-10">
            <ul className="space-y-3 text-sm md:text-lg">
              <li className="wb-marker-red list-disc border-b-2 border-dashed pb-3">
                {" "}
        ...
        {/* Right Section */}
        <div className="w-full md:w-1/2">
          <div className="bg-gradient-to-r from-[#FFF0D5] to-[#FFE8E2] text-white px-8 md:px-10 py-5">
            <h2 className="text-2xl md:text-4xl font-bold mb-4 text-[#430B60]">
              Act as Your B Team to <br /> Power Your Client Deliverables
            </h2>
            <p className="text-sm md:text-lg mt-6 text-black">
