    ...
    <>
      ...
      <div className="container mx-auto bg-white text-black mb-10 px-4 lg:px-0">
        ...
        <div className="flex flex-col space-y-6">
          <div>
            <h1 className="text-2xl lg:text-[64px] font-monument-bold">
              CAREERS
            </h1>
          ...
          <div>
            <h2 className="lg:text-[40px] text-2xl font-monument-bold">
              CURRENT OPENINGS
            </h2>
          </div>
                ...
                >
                  <div className="">
                    <div className="flex-1">
                      ...
                      />
                      <div
                        className="lg:pl-10 pl-5 space-y-2 lg:text-xl"
                        dangerouslySetInnerHTML={{
