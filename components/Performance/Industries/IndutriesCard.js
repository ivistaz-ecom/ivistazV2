        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:pt-20 pt-10 justify-center items-center">
          {IndutriesCardData.map((item, index) => (
            <div key={index} className="group">
              ...
              >
                {/* Animated background */}
                <div className="absolute top-0 -left-1 right-0 bottom-0 bg-black transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-in-out pointer-events-none"></div>
