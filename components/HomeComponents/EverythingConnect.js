  ...
  return (
    <>
      <div className="bg-black">
        <div>
          <h4 className="lg:text-6xl text-2xl text-center text-white">
            Everything <br className="hidden sm:block" /> connects.
          </h4>
        </div>
        ...
        <div>
          <h4 className="lg:text-5xl text-2xl text-center lg: text-white">
