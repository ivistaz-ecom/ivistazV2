...
const LatestInsights = ({ isVisible }) => {
  ...
  return (
    <div className="bg-black pb-10 w-full border-b-2 border-dashed border-[#2D2D2D]">
      <div className="container mx-auto flex justify-between items-end lg:px-0 px-5">
        <div>
        ...
        <div className="flex gap-2 justify-end">
          <button onClick={scrollPrev} className="p-2 rounded-full transition">
            <Image
              ...
              width={25}
              height={25}
              className="rotate-180 lg:w-7 lg:h-7 w-20"
            />
          </button>
          <button
            onClick={scrollNext}
          ...
          >
            <Image
              ...
              width={25}
              height={25}
              className="lg:w-7 lg:h-7 w-20"
            />
          </button>
        </div>
      </div>

      <div className="container mx-auto mt-10 lg:px-0 px-5">
        {loading ? (
